...
void CdsJson::translateOutlierDetection(
  ...
  JSON_UTIL_SET_INTEGER(json_outlier_detection, outlier_detection, consecutive_connection_failure);
  ...
  JSON_UTIL_SET_INTEGER(json_outlier_detection, outlier_detection, enforcing_consecutive_connection_failure);
